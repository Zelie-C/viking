    ...
    override consume(character: Character) {
        switch (this.effect){
            case 0:
                ...
                console.log(`${character} utilise ${this.name} et récupère ${this.power} points de mana`)
                break;
            case 1:
                character.pv *= this.power;
                console.log(`${character} utilise ${this.name} et récupère ${this.power} points de vie`);
                break;
            default:
